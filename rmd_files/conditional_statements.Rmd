...
Add a column called 'PREV_CONVICTIONS_BAND' to the `offenders` dataframe. The column should contain the following categories: '0', '1-5', '6-10', '>10', based on the number of convictions given in the 'PREV_CONVICTIONS' column.
