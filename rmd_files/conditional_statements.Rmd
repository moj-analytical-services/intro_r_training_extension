...
For the conditions themselves, we can make use of any of R's relational and logical operators. Here's a list of common operators:
...
offenders %>% select(BIRTH_DATE, AGE, AGE_BAND) %>% str()
```
