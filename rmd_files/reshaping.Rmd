...
Before we start lets load the required package for this part of the course, namely `tidyverse`: 
...
```{r, purl=purl_example_code ,eval=T}
# for more infomation on th data set 
?billboard
