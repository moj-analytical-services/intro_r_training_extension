...
The code should produce an error, but older versions of `stringr` may give and warning and carry on running. If the code runs without error, in the output you might see that the elements of the shorter vector have been repeated when combined with the additional elements of the longer vector.
