...
Using only functions covered in this part of the course, find the most efficient way to code this from scratch as:
a) A vector of strings
b) A single string, with column names separated by a comma and a space

**Hint:** You may want to create an object in the first part of the question, and recycle it for the second part.
