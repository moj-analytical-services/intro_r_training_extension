...
3. Installed the packages `tidyverse` and `botor` - guidance can be found [here](https://user-guidance.services.alpha.mojanalytics.xyz/appendix/botor.html#installation)
4. Got `example_code.R` open
5. Opened the (C&C repo)[https://github.com/moj-analytical-services/Coffee-and-Coding] on GitHub, so you can refer to the session material in the README
